  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="w-full max-w-5xl bg-white rounded-lg shadow-lg overflow-hidden flex">
        ...
        <div className="w-1/2 flex flex-col justify-between bg-cover bg-blue-600 text-white p-8" 
    ...
    Bridging the gap between freelancers and clients
        ...
        <div className="w-1/2 p-8">
          ...
          <div className="flex items-center justify-between mt-4">
            <button className="w-full flex items-center justify-center border py-2 rounded-md text-gray-700 hover:bg-gray-100 mr-2">
